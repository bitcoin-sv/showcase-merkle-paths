...
export const CompoundMerkleProofProvider: FC<PropsWithChildren> = ({
  children,
}) => {
...
const useCmpContext = () => {
  ...
  if (!ctx) {
    throw new Error(
      "useCompoundMerkleProof must be used within CompoundMerkleProofProvider",
    );
  }
  return ctx;
};
...
export const addNodeToCmp = (
  node: TreePart,
  prvCmp: CompoundMerkleProof,
): CompoundMerkleProof => {
